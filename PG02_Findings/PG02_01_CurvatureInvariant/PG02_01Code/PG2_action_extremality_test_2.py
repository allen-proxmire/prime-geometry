...
# ============================================================
# Segmented prime sieve (pure Python, safe fallback)
# ============================================================
...
# ============================================================
def run_block_test(primes, gaps, block_size, trials, rng):
    ...
    for i in range(trials):
        S_perm[i]  = curvature_action_S(permute_gaps(gaps, rng))
        S_block[i] = curvature_action_S(block_permute_gaps(gaps, block_size, rng))
